          ...
          {upcomingProjects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute top-4 right-4 sm:top-6 sm:right-6">
                <span className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm tracking-wider uppercase rounded-full bg-violet-accent/10 text-violet-accent border border-violet-accent/20">
