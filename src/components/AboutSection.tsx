...
const AboutSection = () => {
  const sectionRef = useSplitTransition({
    direction: 'right',
    triggerPoint: 0.1
  });
  ...
  return <section id="about" ref={parallaxRef} className="min-h-screen py-16 relative" style={{
    ...
    background: 'radial-gradient(ellipse at center, rgba(30, 41, 59, 0.1) 0%, rgba(15, 23, 42, 0.3) 70%, rgba(2, 6, 23, 0.8) 100%)'
      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="max-w-4xl mx-auto">
          <div ref={sectionRef} className="space-y-12 mb-20" style={{
  ...
  <div className="w-full max-w-7xl flex items-center justify-center lg:justify-between gap-8">
    <div ref={projectBoxRef} className="w-full max-w-5xl h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[75vh] rounded-3xl overflow-hidden bg-white/5 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] relative transition-transform duration-300 ease-out" style={{
      ...
      <div className="absolute top-0 left-0 right-0 h-16 bg-white/10 backdrop-blur-md border-b border-white/10 flex items-center justify-between px-6 z-10 rounded-t-3xl">
        ...
        <a href="https://preloved-shoes.lovable.app/" target="_blank" rel="noopener noreferrer" className="text-pink-accent hover:text-pink-accent/80 text-sm font-medium transition-colors">
          Visit App →
        </a>
      </div>

      <iframe src="https://preloved-shoes.lovable.app/" className="w-full h-full pt-16 border-none" title="PreLOVED Shoes App" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" sandbox="allow-same-origin allow-scripts allow-forms allow-popups allow-pointer-lock allow-top-navigation-by-user-activation" style={{
                pointerEvents: 'auto',
                touchAction: 'auto'
              }} />
    </div>
  ...
  <div ref={useProjectScaleAnimation({
            startTrigger: 0.25,
            endTrigger: 0.65,
            direction: 'right'
          }).projectBoxRef} className="text-center">
  ...
  <div className="w-full max-w-7xl flex items-center justify-center lg:justify-between gap-8">
    <div ref={useProjectScaleAnimation({
              ...
              endTrigger: 0.85,
              direction: 'left'
            }).projectBoxRef} className="hidden lg:block text-left">
    ...
    <div ref={useProjectScaleAnimation({
              ...
              endTrigger: 0.9,
              direction: 'right'
            }).projectBoxRef} className="w-full max-w-5xl h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[75vh] rounded-3xl overflow-hidden bg-white/5 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] relative transition-transform duration-300 ease-out" style={{
      ...
      <div className="absolute top-0 left-0 right-0 h-16 bg-white/10 backdrop-blur-md border-b border-white/10 flex items-center justify-between px-6 z-10 rounded-t-3xl">
        ...
        <a href="https://shoe-store.lovable.app/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/80 text-sm font-medium transition-colors">
          Visit App →
        </a>
      </div>

      <iframe src="https://shoe-store.lovable.app/" className="w-full h-full pt-16 border-none" title="Shoe Store App" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" sandbox="allow-same-origin allow-scripts allow-forms allow-popups allow-pointer-lock allow-top-navigation-by-user-activation" style={{
                pointerEvents: 'auto',
                touchAction: 'auto'
              }} />
    </div>
