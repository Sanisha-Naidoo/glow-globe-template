  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      willChange: 'transform, opacity'
        ...
        <h1 className="text-6xl md:text-7xl font-light mb-12 text-white tracking-wide leading-tight">
          imagination lab
        </h1>
        <div className="mb-16"></div>
        <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto leading-relaxed font-light tracking-wide">
          "Where there is love, 
      ...
      <button onClick={scrollToNext} className="absolute bottom-16 left-1/2 transform -translate-x-1/2 z-20 group">
        <div className="flex flex-col items-center space-y-3 text-white hover:text-white/80 transition-all duration-700 ease-out">
